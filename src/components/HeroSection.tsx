...
const HeroSection = () => {
  return (
    <section className="relative border-b border-border/60 min-h-[100dvh] min-h-[85vh] md:min-h-[82vh] lg:min-h-[75vh] flex items-center overflow-hidden">
      {/* Background image */}
      <div
      ...
      {/* Content: left-aligned to match reference */}
      <div className="container relative z-10 w-full pt-6 pb-8 md:pt-10 md:pb-10 lg:pt-14 lg:pb-12 flex items-center min-h-[inherit]">
        ...
        >
          ...
          <h1 className="font-serif text-[1.75rem] leading-tight sm:text-[2.25rem] md:text-[2.75rem] lg:text-[3rem] text-white font-bold">
            Today&apos;s Readers are{" "}
            <span className="text-[#ff5c35] italic font-serif">Tomorrow&apos;s Leaders</span>.
          </h1>
