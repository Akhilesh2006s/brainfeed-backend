        ...
        <section className="py-12 md:py-16">
          <div className="container">
            <ScrollReveal direction="up" once>
              <div className="max-w-3xl space-y-6 font-sans text-muted-foreground leading-relaxed">
                <p>
                  These Terms and Conditions, along with our Privacy Policy and other terms (“Terms”), constitute a binding agreement by and between <strong className="text-foreground">KAKANI EDU MEDIA PRIVATE LIMITED</strong> (“Website Owner” or “we” or “us” or “our”) and you (“you” or “your”) and relate to your use of our website, goods (as applicable) or services (as applicable) (collectively, “Services”).
                </p>
                <p>
